...
const registerUser = asyncHandler( async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(401, "Something went wrong while executing registerUser");
    }
...
const loginUser = asyncHandler( async (req, res) => {
    ...
    try {
        ...
        // find the user based on the credentials received
        ...
        throw new ApiError(401, "Something went wrong while executing loginUser");
    }
